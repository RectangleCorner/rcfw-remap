...
//     (0) // units of 4us; 3ms: if the latest inputs are less than 2 ms apart then don't nerf
//     cardiag

// // not used #define TIMELIMIT_DASH 60000//(16*15*250)//units of 4us; last dash time prior to a
// pivot
// // input; 15 frames
